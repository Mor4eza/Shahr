 ...
 */
public class HTTPGetOnlineAdvancedSearchJson extends AsyncTask<String,Void,Integer>
{
    ProgressDialog pd;
    String urlsearch="";
    Context context;
    ...
    public HTTPGetOnlineAdvancedSearchJson(Context context)
    {
        this.context=context;
    }

    public void SetValueSearch(String value,Integer cityid,String address,String subset)
    {
        urlsearch="http://test.shahrma.com/api/ApiAdvancedSearch?Search="+value+"&cityId="+cityid+"&Address="+address+"&Subset="+subset;
    }
