 ...
 */
public class BookMarkSqlite extends SQLiteOpenHelper
{
    ...
    // Bookmark table name
    private static final String TABLE_BOOKS_RATE = "bookmark";
    ...
    public  BookMarkSqlite(Context context)
    {
    ...
    public void Add(Integer businessid,Integer memberid)
    {
